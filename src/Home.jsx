            ...
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="flex flex-col gap-4 sm:flex-row mt-4">
                ...
                <Link to="/services" className="block">
                  <button className="px-6 py-3 rounded-md border border-teal-600 text-teal-600 font-medium hover:bg-teal-50 transition-colors">
                    Browse Services
                  </button>
                </Link>
              </div>
      ...
      <section className="w-full py-12 md:py-16 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex justify-center">
            <Link to="/services">
              <button className="px-6 py-3 rounded-md border border-teal-600 text-teal-600 font-medium hover:bg-teal-50 transition-colors flex items-center">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center text-white">
            ...
            <div className="flex flex-col gap-4 sm:flex-row mt-6">
              <Link to="/signup">
                <button className="px-6 py-3 rounded-md bg-white text-teal-600 font-medium hover:bg-gray-100 transition-colors">
                  Sign Up Now
                </button>
              </Link>
              <Link to="/services">
                <button className="px-6 py-3 rounded-md border border-white text-white font-medium hover:bg-teal-700 transition-colors">
                  Explore Services
                </button>
              </Link>
            </div>
